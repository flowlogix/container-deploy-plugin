...
*   `payara:deps`: Copies project dependencies to the server's `lib/warlibs` directory.
*   `payara:remove-deps`: Removes all dependencies from the server's `lib/warlibs` directory.
